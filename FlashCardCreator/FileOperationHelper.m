...
+ (NSString *) zipCardForUpload:(Card *) card {
    ...
    NSDictionary *questionDict = [NSDictionary dictionaryWithObjectsAndKeys:card.question.title,@"title",card.question.main,@"main",card.question.sub,@"sub",card.question.subheading,@"subheading",[card.question.imageFullPath lastPathComponent]?:@"",@"image",[card.question.imageFullPath2 lastPathComponent]?:@"",@"image2",[card.question.logoFullPath lastPathComponent]?:@"",@"logo", card.question.logoURLLinkage,@"logo_url",card.creator,@"creator",[card.coverImageURL lastPathComponent]?:@"",@"cover_image",card.templateBackgroundName,@"template_background",[NSString stringWithFormat:@"%ld",(long)card.cardSN],@"cardSN",[NSString stringWithFormat:@"%ld",(long)card.question.templateID],@"template_id",card.question.css.subheadingAlign,@"subheading_align",card.question.css.subheadingColor,@"subheading_color",card.question.css.subheadingText2SpeechSound,@"subheading_text2speech",card.question.css.mainText2SpeechSound,@"main_text2speech",card.question.css.subText2SpeechSound,@"sub_text2speech",[NSString stringWithFormat:@"%d",(int)card.question.css.subheadingSize],@"subheading_size",card.question.css.mainAlign,@"main_align",card.question.css.mainColor,@"main_color",[NSString stringWithFormat:@"%d",(int)card.question.css.mainSize],@"main_size",card.question.css.subAlign,@"sub_align",card.question.css.subColor,@"sub_color",[NSString stringWithFormat:@"%d",(int)card.question.css.subSize],@"sub_size",
        [NSString stringWithFormat:@"%ld",(long)card.question.lineNoSubheading],@"line_number_subheading",
                [NSString stringWithFormat:@"%ld",(long)card.question.lineNoMain],@"line_number_main",
                        [NSString stringWithFormat:@"%ld",(long)card.question.lineNoSub],@"line_number_sub",[card.question.backgroundImageFullPath lastPathComponent]?:@"",@"background_image",
    ...
    NSDictionary *anserDict = [NSDictionary dictionaryWithObjectsAndKeys:card.answer.title,@"title",card.answer.main,@"main",card.answer.sub,@"sub", card.answer.subheading,@"subheading",[card.answer.imageFullPath lastPathComponent]?:@"",@"image",[card.answer.imageFullPath2 lastPathComponent]?:@"",@"image2",[card.answer.logoFullPath lastPathComponent]?:@"",@"logo",[NSString stringWithFormat:@"%ld",(long)card.answer.templateID],@"template_id", card.answer.css.subheadingAlign,@"subheading_align",card.answer.css.subheadingColor,@"subheading_color",card.answer.css.subheadingText2SpeechSound,@"subheading_text2speech",card.answer.css.mainText2SpeechSound,@"main_text2speech",card.answer.css.subText2SpeechSound,@"sub_text2speech",[NSString stringWithFormat:@"%d",(int)card.answer.css.subheadingSize],@"subheading_size",card.answer.css.mainAlign,@"main_align",card.answer.css.mainColor,@"main_color",[NSString stringWithFormat:@"%d",(int)card.answer.css.mainSize],@"main_size",card.answer.css.subAlign,@"sub_align",card.answer.css.subColor,@"sub_color",[NSString stringWithFormat:@"%d",(int)card.answer.css.subSize],@"sub_size",
        [NSString stringWithFormat:@"%ld",(long)card.answer.lineNoSubheading],@"line_number_subheading",
            [NSString stringWithFormat:@"%ld",(long)card.answer.lineNoMain],@"line_number_main",
                    [NSString stringWithFormat:@"%ld",(long)card.answer.lineNoSub],@"line_number_sub",[card.answer.backgroundImageFullPath lastPathComponent]?:@"",@"background_image",
