...
+(NSMutableDictionary *) questionForCardID:(NSInteger)cardID{
	...
	while (sqlite3_step(queryStatement) == SQLITE_ROW) {
        ...
        [questionDict setValue:[SQLiteHelper getStringFromQuery:queryStatement inColumn:17] forKey:@"font"];
