...
//  MyShareKit
//
//  Created by Wang Bourne on 30/11/12.
//  Copyright (c) 2012 Wang Bourne. All rights reserved.
//
...
- (NSString*)twitterConsumerKey {
	return @"jHDbwcvEk3sgpjMTUuQQ";
}

- (NSString*)twitterSecret {
	return @"QQ02oEEwaZboQZdPZ8EwF7oAkAhhBSjKtXmytsE1A";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://www.internetics.net.au";
}
