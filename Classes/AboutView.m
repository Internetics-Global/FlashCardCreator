...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
		...
		if (isUserInterfaceIdiomPhone) {
            textView = [[UITextView alloc] initWithFrame:CGRectMake(0, 0, width, 180)];    
        } else {
        ...
        UILabel *verionLable = [[UILabel alloc] initWithFrame:CGRectMake(0, (linkButton.frame.origin.y + linkButton.frame.size.height + 20), width, 20)];
